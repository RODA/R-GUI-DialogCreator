...
function fn() {
    ...
    el.innerText = 'Emilianooooooooooooooooo';

    el.setAttribute("id", "mytxtlenght");

    var helper = document.getElementById('helper').appendChild(el);


    console.log('eeee');
    

    console.log(helper.offsetWidth);

    // var a = document.getElementById('mytxtlength');

    // console.log(aaa.offsetWidth);
}
